...
class Info:
    ...
    def create_state_labels(self):
        ...
        if self.state == 'main_menu':
           self.state_labels.append((self.create_label('SUPER UTSER'), (272, 360)))
           self.state_labels.append((self.create_label('PLAY    GAME'), (272, 405)))
           self.state_labels.append((self.create_label('TOP - '), (272, 465)))
    ...
    def create_info_labels(self):
        self.info_labels = []
        self.info_labels.append((self.create_label('UTSER'), (75, 30)))
        self.info_labels.append((self.create_label('WORLD'), (450, 30)))
        self.info_labels.append((self.create_label('TIME'), (625, 30)))
        self.info_labels.append((self.create_label('0000000'), (75, 55)))
